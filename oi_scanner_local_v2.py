...
SIGNAL_TRACKER_FILE = os.path.expanduser("~/.openclaw/signal_tracker.json")
...
def update_tracker_and_filter(alerts):
    ...
    logs = [l for l in logs if datetime.fromisoformat(l["ts"]) > cutoff - timedelta(days=7)]
