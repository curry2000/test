...
DISCORD_PING_USER_ID = os.environ.get("DISCORD_PING_USER_ID", "301719003800403968")
DISCORD_MAIN_CHANNEL_ID = os.environ.get("DISCORD_MAIN_CHANNEL_ID", "1471200792945098955")
